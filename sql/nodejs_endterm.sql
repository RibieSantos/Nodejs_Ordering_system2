...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 07, 2024 at 09:40 PM
...
INSERT INTO `users` (`id`, `fullname`, `gender`, `contact`, `birthdate`, `address`, `email`, `password`, `user_type`) VALUES
(1, 'Admin Administrator', 'Male', '09203331922', '03-14-2002', 'San Roque', 'admin@gmail.com', '$2b$10$d1TPuNUTefWBsh0V9nH/v.PEctAGTv9/U9X7iPrn7m3uokoqGYjfG', 'admin'),
(5, 'ribie santos', 'Male', '', '12-43-2332', '', 'c@g.c', '$2b$10$d1TPuNUTefWBsh0V9nH/v.PEctAGTv9/U9X7iPrn7m3uokoqGYjfG', 'customer'),
(6, 'Arjay Lalas', 'Male', '093323453', '2024-01-02', 'Tabuyoc', 'arjay@gmail.com', '$2b$10$7YliMzcpv/OnJBPqkzdL5OhxE2GusGNbvKsK9F/FQdggRLY2TvZvy', 'customer'),
